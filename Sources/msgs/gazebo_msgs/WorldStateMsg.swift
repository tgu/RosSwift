...
extension gazebo_msgs {
	...
	///
	public struct WorldState: MessageWithHeader {
		public static let md5sum: String = "de1a9de3ab7ba97ac0e9ec01a4eb481e"
		public static let datatype = "gazebo_msgs/WorldState"
