...
extension sensor_msgs {
	...
	public struct MagneticField: Message {
		...
		public var magnetic_field_covariance: FixedLengthArray<Float64>

		public init(header: std_msgs.Header, magnetic_field: geometry_msgs.Vector3, magnetic_field_covariance: [Float64]) {
			self.header = header
			self.magnetic_field = magnetic_field
			self.magnetic_field_covariance = FixedLengthArray(length: 9, array: magnetic_field_covariance)
		}

		public init() {
			header = std_msgs.Header()
			magnetic_field = geometry_msgs.Vector3()
			magnetic_field_covariance = FixedLengthArray(length: 9, array: [Float64](repeating: 0, count: 9))
		}
	}
}