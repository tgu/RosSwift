...
public var timestep: RosTime.Duration
...
public init(header: std_msgs.header, timestep: RosTime.Duration, error: Float64, error_dot: Float64, p_error: Float64, i_error: Float64, d_error: Float64, p_term: Float64, i_term: Float64, d_term: Float64, i_max: Float64, i_min: Float64, output: Float64) {
self.header = header
